...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2018 at 11:38 AM
...
(4, 'Naira', 'NGN', '₦', '', '2', 1.00000000, 1, '2018-05-22 07:39:54');
...
(82, 'test101', '', '', '', '', '', '', '', 1, 6, 'catalog/demo_tshirtecommerce_b015247590605ae1fa14a711e.png', 0, 1, '0.0000', 0, 0, '2018-05-08', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, 94, '2018-05-08 11:04:27', '2018-05-08 11:13:06', '73', 'test1::http://localhost/saw_main///image/catalog/demo_tshirtecommerce_b015247590605ae1fa14a711e.png'),
...
--
ALTER TABLE `oc_cmsblock_description`
  MODIFY `cmsblock_des_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
--
ALTER TABLE `oc_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `oc_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `oc_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=872;

--
-- AUTO_INCREMENT for table `oc_setting`
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3153;
...
--
ALTER TABLE `oc_tshirtecommerce_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
