...
class Product extends Controllers
{
	...
	{	
		...
		{
			$path 	= dirname(ROOT) .DS. 'data';
			$data['error'] = 'Your server not allow write file. Please set permission and sure your server allow write of folder <strong>'.$path.'</strong>';	
		}
