			...
			<div class="box-design-wapper">
				<div class="design-tools">
					...
					<div class="pull-right design-group design-group-area design-group-img">
						<button class="btn btn-xs btn-med-grey" type="button" onclick="dgUI.product.move('up')"><i class="clip-arrow-up-3"></i></button>
						<button class="btn btn-xs btn-med-grey" type="button" onclick="dgUI.product.move('down')"><i class="clip-arrow-down-3"></i></button>
						<button class="btn btn-xs btn-med-grey" type="button" onclick="dgUI.product.move('left')"><i class="clip-arrow-left-3"></i></button>
						<button class="btn btn-xs btn-med-grey" type="button" onclick="dgUI.product.move('right')"><i class="clip-arrow-right-3"></i></button>
						<button class="btn btn-xs btn-med-grey" type="button" onclick="dgUI.product.move('center')"><i class="clip-fullscreen-exit-alt"></i></button>
					</div>
				</div>
				<div class="box-design-right">
					<div class="panel-options">
						<div class="form-group">
							<h5>Layers <button class="btn pull-right btn-xs btn-dark-grey" type="button" onclick="jQuery.fancybox( {href : '<?php echo site_url('index.php/media/modals/design/2') ?>', type: 'iframe', topRatio: 0, beforeShow: function() {jQuery('.fancybox-wrap').css('top', '130px')}} );">Add Image</button></h5>
							<ul id="layers"></ul>
						</div>
