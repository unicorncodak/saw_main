...
<ul class="nav nav-tabs">
  ...
  <li><a href="#design-store" data-toggle="tab">Design Store</a></li>
...
<div class="tab-content">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row col-md-12">
					...
					<div class="form-group row">
						<div class="col-sm-12">
							<a href="<?php echo site_url('index.php/printing'); ?>" class="btn btn-default">Add new printing</a>
						</div>
					</div>
	...
	<div class="tab-pane" id="design-store">
		<div class="row">
			<?php include_once('settings/store.php'); ?>
		</div>
	</div>
</div>
</form>
