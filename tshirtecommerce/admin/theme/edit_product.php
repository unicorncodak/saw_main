			...
			<div class="tab-content">
				<div class="tab-pane active" id="panel_tab2_example1">
					...
					<div class="row">
						...
						<!-- Begin righ -->
						<div class="col-sm-4 col-md-4" style="display: none!important;">
									...
									<div id="tabs-1" class="tab-pane active">
										...
										<div class="form-group">
											...
											<div class="col-sm-offset-3 col-sm-9">
												<p class="help-block">Note: Calculate price of printing based printing type. <a href="<?php echo site_url('index.php/printing'); ?>">Setup Printing type</a></p>
											</div>
										</div>
