...
<head>
	...
	<script type="text/javascript">
		var path_admin = '<?php echo addslashes(ROOT.DS); ?>';
		...
		var ajax_url = site_url + 'admin/index.php?route=catalog/tshirtecommerce/tshirt_user_is_login&token='+getUrlParameter('token');
