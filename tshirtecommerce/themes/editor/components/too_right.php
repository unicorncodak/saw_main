<style>
   .product-prices button.btn-addcart{
       background-color: #3167bf!important;
   }
</style>
		...
		<div class="row" id="right-options">
			...
			<div class="product-prices col-sm-6">
				<div class="product-cart">
					<button <?php echo cssShow($settings, 'show_add_to_cart', 1); ?> type="button" class="btn btn-warning btn-addcart" onclick="design.ajax.addJs(this)"><i class="glyph-icon flaticon-shopping-cart"></i> <?php echo lang('designer_right_buy_now'); ?></button>
